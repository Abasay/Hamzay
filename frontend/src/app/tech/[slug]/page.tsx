...
//   // Return an array of slugs to pre-generate the pages
//   return blogs.map((blog: { slug: string; _id: string }) => ({
//     slug: blog._id,
//   }));
// }
...
export async function generateMetadata({
  ...
  return {
    ...
    description: post.excerpt || post.description, // Dynamic description
    openGraph: {
      title: post.title,
      ...
      images: [
        {
          url: post.coverImage || "/default-cover.jpg",
          alt: post.title,
        },
      ],
    },
    twitter: {
      ...
      title: post.title,
      description: post.excerpt || post.description,
      images: [post.coverImage || "/default-cover.jpg"],
    },
  };
}
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="shadow-three mb-10 mt-12 rounded-sm bg-white p-6 dark:bg-gray-dark dark:shadow-none lg:mt-0">
                <div className="flex items-center justify-between">
                  <input
                    type="text"
                    placeholder="Search here..."
                    className="border-stroke dark:shadow-two mr-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:focus:border-primary dark:focus:shadow-none"
                  />
                  <button
              ...
              <div className="shadow-three mb-10 rounded-sm bg-white dark:bg-gray-dark dark:shadow-none">
                ...
                <div className="flex flex-wrap px-8 py-6">
                  ...
                  <TagButton text={post.tags[1]} />
                  <TagButton text={post.tags[2]} />
                  <TagButton text={post.tags[3]} />
