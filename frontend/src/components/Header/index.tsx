...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="relative -mx-4 flex items-center justify-between ">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  <ul className="block lg:ml-32 lg:flex lg:space-x-12">
      ...
      {/* <div className="mt-20 flex justify-center border-t border-t-zinc-600">
        <span className=" rounded-sm border  border-black">
          <input type="text" className=" py-2 focus-within:outline-none" />
        </span>
      </div> */}
    </>
  );
