        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="relative w-full px-4">
              ...
              <div>
                {/* <div className="absolute inset-0 bg-gradient-to-b from-white opacity-50 dark:from-gray-dark dark:to-gray-dark"></div>
                <div className="absolute inset-0 bg-gradient-to-b from-white opacity-50 dark:from-gray-dark dark:to-gray-dark"></div> */}
                <div className=" absolute top-[70%] ml-12 flex h-[280px] w-[500px] flex-col gap-3 rounded-2xl bg-white px-6 py-8 shadow-xl ">
                  ...
                  <div className=" mt-2 flex flex-row items-center gap-3 text-base font-medium text-slate-300">
                    <Image
                      src="/images/hero/hero-img.jpg"
                      alt="Hero Image"
                      width={20}
